...
<body>
	...
	<div class="container">
		<div class="upload">
			<!-- <div class="title">IPFS图床<small style="font-size:10px;">(文件传到ipfs星际文件系统)</small><input id="icu" autocomplete="off" maxlength="16" style="display: none;" placeholder="请上传..."> -->
			<!-- </div> -->
		...
		<div class="filelist">
			<div class="title">上传列表
				<!-- <div class="copyall" style="display:none">
					<button title="ipfs.io永久链接国内不能访问| cf-ipfs.com是cloudflare节点 | icu.me是本站提供节点" style="width:auto;background-color: #d0dbee;">网关<span class="tooltiptext">ipfs.io永久链接国内不能访问| cf-ipfs.com是cloudflare节点 | icu.me是本站提供节点</span></button>
			    ...
			    <div class="copyall" style="display:none">
					<!-- <button onclick="copyAll(this);" name="icu" id="copyAll" style="width:auto;background-color: #d0dbee;"></button> -->
	...
	<div id="footer" style="position:fixed; width:auto; text-align:center; bottom:0px; display:block;">
		...
		© 
		<a style="text-decoration:none;" href="https://api.icu.me/">更多：icu.Me
		</p>
		</div>
		</div> -->
</body>
